namespace SNR_ClientApp.Windows.CustomControls.AutomationControls
{
    partial class TalllyConnect
    {
		...
		private void InitializeComponent()
		{
			...
			button3.FlatAppearance.MouseDownBackColor = Color.FromArgb(0, 64, 0);
			button3.FlatAppearance.MouseOverBackColor = Color.ForestGreen;
			button3.FlatStyle = FlatStyle.Flat;
			button3.Font = new Font("Nirmala UI", 11.25F, FontStyle.Bold, GraphicsUnit.Point);
			button3.ForeColor = Color.White;
			button3.Location = new Point(162, 316);
			...
			pictureBox5.Location = new Point(342, 189);
			...
			label1.Location = new Point(162, 160);
			label1.Name = "label1";
			...
			pictureBox4.Location = new Point(344, 274);
			...
			pictureBox2.Location = new Point(344, 125);
			...
			companySelect.Location = new Point(74, 274);
			...
			txtPort.Location = new Point(74, 120);
			...
			label3.Location = new Point(183, 95);
			label3.Name = "label3";
