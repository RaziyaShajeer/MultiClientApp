namespace SNR_ClientApp.Windows.CustomControls
{
    partial class UC_UploadSalesReceipt
    {
		...
		private void InitializeComponent()
		{
			...
			DatePicker.Location = new Point(15, 0);
			...
			// FromDate
			// 
			FromDate.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			FromDate.Location = new Point(15, 33);
			FromDate.Margin = new Padding(10, 3, 3, 3);
			FromDate.Name = "FromDate";
			FromDate.Size = new Size(215, 23);
			FromDate.TabIndex = 1;
			// 
			// Btn_Receipt
			// 
			...
			// panel1
			// 
			panel1.Controls.Add(companySelect);
			...
			companySelect.Location = new Point(15, 15);
