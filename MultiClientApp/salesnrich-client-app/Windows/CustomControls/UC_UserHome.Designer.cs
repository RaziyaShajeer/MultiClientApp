namespace SNR_ClientApp.Windows.CustomControls
{
    partial class UC_UserHome
    {
		...
		private void InitializeComponent()
		{
			...
			flowLayoutPanel1.Size = new Size(291, 632);
			...
			chk_productProfile.CheckedChanged += chk_productProfile_CheckedChanged;
			// 
			// chk_openingStock
			// 
			...
			chk_groupWiseAccount.CheckedChanged += chk_groupWiseAccount_CheckedChanged;
			// 
			...
			loggerPanel.Location = new Point(291, 0);
			loggerPanel.Name = "loggerPanel";
			loggerPanel.Size = new Size(509, 632);
