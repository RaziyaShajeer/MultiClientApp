...
namespace SNR_ClientApp.Windows
{
	public partial class LoginScreen : Form
	{
		...
		public LoginScreen()
		{
			...
			InitializeComponent();
			props = ApplicationProperties.Userinitialproperty();
		...
		{
			ApplicationProperties.Userinitialproperty();
			if (ApplicationProperties.userinitialproperty["RememberMe"].ToString().Equals("true", StringComparison.OrdinalIgnoreCase))
			{
				username.Text = ApplicationProperties.userinitialproperty["RememberUser"].ToString();
				password.Text = ApplicationProperties.userinitialproperty["RememberPass"].ToString();
				...
				if (ValidateChildren(ValidationConstraints.Enabled))
				{
					...
					if (res != null && res.IsSuccessStatusCode)
					{
						...
						if (isAuthenticated)
						{
							...
							{
								ApplicationProperties.userinitialproperty["RememberMe"] = "True";
								ApplicationProperties.userinitialproperty["RememberUser"] = loginDto.username;
								ApplicationProperties.userinitialproperty["RememberPass"] = loginDto.password;
...

							{
								...
								ApplicationProperties.userinitialproperty["isFirstTimeLogin"] = "False";
								if (rememberMeChkBox.Checked)
								{
									ApplicationProperties.userinitialproperty["RememberMe"] = "True";
									ApplicationProperties.userinitialproperty["RememberUser"] = loginDto.username;
