...
{
	public  static class StockItemGroupXML
	{
		public static ENVELOPE getCompanystockitemXml()
		{
			...
			line.FIELD = "Name,Guid,Parent,AlterID";
			...
			collection.FETCH = "Name,Parent,AlterID";
