...
{
	public static class AccountProfileXml
	{
		public static ENVELOPE GenerateAccountProfileXml()
		{
			...
			line.FIELD = "Field FullAddress,Field Address1, Field Address2,Field FullAddress, Field PriceLevel, Field Parent, Field TaxType, Field LedgerMobile, Field LedStateName, Field CountryofResidence, Field Name, Field MailingName, Field GSTRegistrationType, Field PartyGSTIN, Field PinCode, Field Guid, Field Alterid, Field HasEDDCity";
			List<LINE> lines = new List<LINE>();
			lines.Add(line);
			tdlmessage.LINE = lines;
			List<FIELD> fieldList = new List<FIELD>();
			FIELD field = new FIELD();
			field.NAME = "Field FullAddress";
			field.ISMODIFY = "No";
			field.ISFIXED = "No";
			field.ISINITIALIZE = "No";
			field.ISOPTION = "No";
			field.ISINTERNAL = "No";
			field.SET = "$$String:$Address";
			field.XMLTAG = "FULLADDRESS";
			fieldList.Add(field);
			FIELD field1 = new FIELD();
			field1.NAME = "Field Address1";
			field1.ISMODIFY = "No";
			field1.ISFIXED = "No";
			field1.ISINITIALIZE = "No";
			field1.ISOPTION = "No";
			field1.ISINTERNAL = "No";
			field1.SET = "$_Address1";
			field1.XMLTAG = "Address1";
			fieldList.Add(field1);
			FIELD field2 = new FIELD();
			field2.NAME = "Field Address2";
			field2.ISMODIFY = "No";
			field2.ISFIXED = "No";
			field2.ISINITIALIZE = "No";
			field2.ISOPTION = "No";
			field2.ISINTERNAL = "No";
			field2.SET = "$_Address2";
			field2.XMLTAG = "Address2";
			fieldList.Add(field2);
			FIELD field3 = new FIELD();
			field3.NAME = "Field PriceLevel";
			field3.ISMODIFY = "No";
			field3.ISFIXED = "No";
			field3.ISINITIALIZE = "No";
			field3.ISOPTION = "No";
			field3.ISINTERNAL = "No";
			field3.SET = "$PriceLevel";
			field3.XMLTAG = "PriceLevel";
			...
			field6.NAME = "Field LedgerMobile";
			field6.ISMODIFY = "No";
			field6.ISFIXED = "No";
			field6.ISINITIALIZE = "No";
			field6.ISOPTION = "No";
			field6.ISINTERNAL = "No";
			field6.SET = "$LedgerMobile";
			field6.XMLTAG = "LedgerMobile";
			fieldList.Add(field6);
			FIELD field7 = new FIELD();
			field7.NAME = "Field LedStateName";
			field7.ISMODIFY = "No";
			field7.ISFIXED = "No";
			field7.ISINITIALIZE = "No";
			field7.ISOPTION = "No";
			field7.ISINTERNAL = "No";
			field7.SET = "$LedStateName";
			field7.XMLTAG = "LedStateName";
			fieldList.Add(field7);
			FIELD field8 = new FIELD();
			field8.NAME = "Field CountryofResidence";
			field8.ISMODIFY = "No";
			field8.ISFIXED = "No";
			field8.ISINITIALIZE = "No";
			field8.ISOPTION = "No";
			field8.ISINTERNAL = "No";
			field8.SET = "$CountryofResidence";
			field8.XMLTAG = "CountryofResidence";
			fieldList.Add(field8);
			FIELD field9 = new FIELD();
			field9.NAME = "Field Name";
			field9.ISMODIFY = "No";
			field9.ISFIXED = "No";
			...
			field10.NAME = "Field MailingName";
			field10.ISMODIFY = "No";
			field10.ISFIXED = "No";
			field10.ISINITIALIZE = "No";
			field10.ISOPTION = "No";
			field10.ISINTERNAL = "No";
			field10.SET = "$MailingName";
			field10.XMLTAG = "MailingName";
			fieldList.Add(field10);
			FIELD field11 = new FIELD();
			field11.NAME = "Field GSTRegistrationType";
			field11.ISMODIFY = "No";
			field11.ISFIXED = "No";
			field11.ISINITIALIZE = "No";
			field11.ISOPTION = "No";
			field11.ISINTERNAL = "No";
			field11.SET = "$GSTRegistrationType";
			field11.XMLTAG = "GSTRegistrationType";
			fieldList.Add(field11);
			FIELD field12 = new FIELD();
			field12.NAME = "Field PartyGSTIN";
			field12.ISMODIFY = "No";
			field12.ISFIXED = "No";
			field12.ISINITIALIZE = "No";
			field12.ISOPTION = "No";
			field12.ISINTERNAL = "No";
			field12.SET = "$PartyGSTIN";
			field12.XMLTAG = "PartyGSTIN";
			fieldList.Add(field12);
			FIELD field13 = new FIELD();
			field13.NAME = "Field PinCode";
			field13.ISMODIFY = "No";
			field13.ISFIXED = "No";
			...
			field13.SET = "$PinCode";
			field13.XMLTAG = "PinCode";
			fieldList.Add(field13);
			FIELD field14 = new FIELD();
			field14.NAME = "Field Guid";
			field14.ISMODIFY = "No";
			field14.ISFIXED = "No";
			...
			field15.XMLTAG = "AlterID";
			FIELD field16 = new FIELD();
			field16.NAME = "Field HasEDDCity";
			field16.ISMODIFY = "No";
			field16.ISFIXED = "No";
			field16.ISINITIALIZE = "No";
			field16.ISOPTION = "No";
			field16.ISINTERNAL = "No";
			field16.SET = "$HasEDDCity";
			field16.XMLTAG = "HasEDDCity";
			...
			collection.FETCH = "Name,Parent,Address,_Address1,_Address2,PriceLevel,TaxType,LedgerMobile,LedStateName,CountryofResidence,MailingName,GSTRegistrationType,PartyGSTIN,PinCode,Guid,Alterid,HasEDDCity";
