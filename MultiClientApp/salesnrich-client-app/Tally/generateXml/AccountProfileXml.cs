...
namespace SNR_ClientApp.Tally.generateXml
{
	public static class AccountProfileXml
	{
		public static ENVELOPE GenerateAccountProfileXml()
		{
			...
			collection.FETCH = "NAME,PARENT,ADDRESS,TAXTYPE,PRICELEVEL,SUBTAXTYPE,LEDGERMOBILE,LEDSTATENAME,COUNTRYOFRESIDENCE,GSTREGISTRATIONTYPE,PINCODE,GUID,PARTYGSTIN,HASEDDCITY,MAILINGNAME";
